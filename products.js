...
Like a totem, it stands tall, carrying the weight of memories, of connections, of legacy. **Sold without lampshade.**`,
  ...
  'sun-face': {
    id: 'sun-face', name: 'Sun Vessel',
    category: ['functional'], status: 'available', wholesaleAvailable: true,
    price: 97, fragile: true,
    dims: { w: 10.5, h: 7, d: 10.5 },
    weight: 0.26, productionCost: 5, hoursWorked: 4, packingEfficiency: 0.25,
    materials: 'Ceramic',
    description: `Sun Vessel — a small but powerful character with a beautiful, creative, and unique ethnic-inspired design. Colorful, playful, and dreamy, this little piece can become whatever you want it to be. A quiet candle holder, a guardian for your keys, or simply a joyful object to bring personality to your space. What would you use it for? You choose.`,
    images: ['images/sun-face-01.png', 'images/sun-face-02.png','images/sun-face-03.mp4'],
  },
  'melt-face': {
    ...
    dims: { w: 14, h: 9, d: 11 },
    weight: 0.6, productionCost: 5, hoursWorked: 3, packingEfficiency: 0.25,
    materials: 'Ceramic',
