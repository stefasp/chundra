...
Like a totem, it stands tall, carrying the weight of memories, of connections, of legacy. **Sold without lampshade.**`,
  ...
  bird: {
    ...
    dims: { w: 20, h: 20, d: 1.5 },
    weight: 0.3, productionCost: 1, hoursWorked: 2, framed: 'unframed', flatPackable: true,
  ...
  wait: {
    ...
    weight: 1.2, productionCost: 6, hoursWorked: 3, framed: 'framed', flatPackable: true,
  ...
  horizons: {
    ...
    category: ['cuadros'], status: 'available', wholesaleAvailable: false,
