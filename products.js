// products.js — Chundra
// Single source of truth. All dims in cm, weight in kg.
// fragile: true → 4cm bubble-wrap padding added on all sides for shipping calc.
// Shipping box assigned automatically by shipping.js based on padded dims.
// For oversized pieces, shippingNote overrides the auto-calc and shows a custom quote message.
...
const PRODUCTS = {
  ...
  ariadna: {
    id: 'ariadna',
    name: 'Ariadna',
    subtitle: 'a quiet enigma',
    category: ['guardianas'],
    status: 'available',
    price: 90,
    fragile: true,
    dims: { w: 17, h: 32.5, d: 16.5 },  // padded → 25×40.5×24.5 → LARGE box
    weight: 1.42,
...
Ariadna does not impose direction; she refines it. Her presence is light, almost floating, but carries a deep certainty. She reminds us that not all tensions must be broken — some are meant to be held, transformed, and woven into something precise, something beautiful.`,
  ...
  zaira: {
    id: 'zaira',
    name: 'Zaira',
    subtitle: 'the wisdom of the flesh',
    category: ['guardianas'],
    status: 'available',
    price: 120,
    priceSale: 103,
    fragile: true,
    dims: { w: 16, h: 21, d: 19 },  // padded → 24×29×27 → LARGE box
    weight: 0.96,
...
Zaira calls us back to the flesh, to the awareness of our mortality, to a more vivid way of being. She invites us to awaken a quiet, humble wisdom.`,
  ...
  juana: {
    id: 'juana',
    name: 'Guardian Juana',
    subtitle: 'feline strength',
    category: ['guardianas'],
    status: 'available',
    price: 76,
    priceSale: 56,
    fragile: true,
    dims: { w: 12.5, h: 15, d: 3 },  // padded → 20.5×23×11 → MEDIUM box
    weight: 0.36,
  ...
  mara: {
    id: 'mara',
    name: 'Guardian Mara',
    subtitle: 'the power to nest, the power to fly',
    category: ['guardianas'],
    status: 'available',
    price: 76,
    priceSale: 56,
    fragile: true,
    dims: { w: 13.5, h: 14, d: 4 },  // padded → 21.5×22×12 → MEDIUM box
    weight: 0.45,
    materials: 'Ceramic and fabric',
  ...
  lunar: {
    id: 'lunar',
    name: 'Lunar Guardian',
    subtitle: 'movement of life and femininity',
    category: ['guardianas', 'ritual'],
    status: 'available',
    price: 90,
    fragile: true,
    dims: { w: 14.5, h: 17.5, d: 10 },  // padded → 22.5×25.5×18 → MEDIUM box
    weight: 0.58,
    materials: 'Ceramic',
...
Ritual: Includes a guided exercise to help reconnect with our inner cycles and prepare for moments of introspection and strength.`,
  ...
  marina: {
    id: 'marina',
    name: 'Guardian Marina',
    subtitle: 'transformative power of depth',
    category: ['guardianas', 'ritual'],
    status: 'available',
    price: 72,
    fragile: true,
    dims: { w: 15, h: 19, d: 12.5 },  // padded → 23×27×20.5 → LARGE box
    weight: 1.0,
...
Ritual: Includes an exercise to help you face challenges or fears, connecting with a stronger, renewed version of yourself.`,
    images: [
      'images/marina-00.png',
      'images/marina-01.png',
      'images/marina-02.png',
      'images/marina-03.png',
    ],
  },

  salamanca: {
    id: 'salamanca',
    name: 'Guardian Salamanca',
    subtitle: 'guardian of transition',
    category: ['guardianas', 'ritual'],
    status: 'available',
    price: 89,
    priceSale: 76,
    fragile: true,
    dims: { w: 16, h: 18.5, d: 13 },  // padded → 24×26.5×21 → LARGE box
    weight: 1.0,
...
Ritual: Includes an exercise inviting reflection on inherited mandates and consciously choosing what we want to continue.`,
    images: [
      'images/salamanca-00.png',
      'images/salamanca-01.png',
      'images/salamanca-02.png',
      'images/salamanca-03.png',
    ],
  },
  ...
  trina: {
    id: 'trina',
    name: 'Guardian Trina',
    subtitle: 'the dreams protector',
    category: ['guardianas', 'ritual'],
    status: 'available',
    price: 89,
    priceSale: 76,
    fragile: true,
    dims: { w: 10, h: 15, d: 10 },  // padded → 18×23×18 → MEDIUM box
    weight: 0.56,
    materials: 'Ceramic and fabric',
...
Ritual: Includes an exercise to dialogue with the past and reconstruct it in a way that creates a positive impact, broadening our perspective.`,
  ...
  amalia: {
    id: 'amalia',
    name: 'Guardian Amalia',
    subtitle: 'conscious serenity',
    category: ['guardianas', 'ritual'],
    status: 'available',
    price: 160,
    priceSale: 123,
    fragile: true,
    dims: { w: 13, h: 38, d: 13 },  // padded → 21×46×21 → LARGE box (rotated)
    weight: 1.45,
    materials: 'Ceramic',
...
Includes a ritual to reconnect with the present and cultivate a kinder, more serene inner state, through the creation of a personal mantra to accompany your meditations.`,
    images: [
      'images/amalia-01.png',
      'images/amalia-02.png',
      'images/amalia-03.png',
    ],
  },
  ...
  traveler: {
    ...
    subtitle: 'the ancient messenger',
    category: ['viajeros'],
    status: 'available',
    price: 93,
    fragile: true,
    dims: { w: 18.5, h: 17.5, d: 16 },  // padded → 26.5×25.5×24 → LARGE box
    weight: 1.1,
...
This piece was sketched while wandering through the Gibralfaro mountain in Málaga. The traveler carries with him something ancient, almost aboriginal, like the aesthetic of an ancient script, as though telling a story from a distant time.`,
  ...
  gibran: {
    id: 'gibran',
    name: 'Traveler Gibran',
    subtitle: 'a fully present traveler',
    category: ['viajeros'],
    status: 'available',
    price: 80,
    fragile: true,
    dims: { w: 15, h: 12, d: 6.5 },  // padded → 23×20×14.5 → MEDIUM box
    weight: 0.35,
    materials: 'Ceramic',
...
This piece is a reminder that the essential thing is not to accumulate places, but to live the present fully. Destinations fade, but emotions and shared moments remain.`,
    images: [
      'images/gibran-00.png',
      'images/gibran-01.png',
      'images/gibran-02.png',
      'images/gibran-03.png',
    ],
  },
  ...
  totem: {
    id: 'totem',
    name: 'Totem of Legacy',
    subtitle: 'cycle of life',
    category: ['lamparas'],
    status: 'available',
    price: 104,
    fragile: true,
    dims: { w: 25.3, h: 46, d: 25.3 },  // padded → 33.3×54×33.3 → OVERSIZED
    weight: 1.35,
    materials: 'Ceramic',
    shippingNote: 'Shipping cost on request — this piece requires custom packaging due to its height. Contact me for a quote before purchasing.',
...
Like a totem, it stands tall, carrying the weight of memories, of connections, of legacy. Sold without lampshade.`,
  ...
  carnival: {
    ...
    priceSale: 120,
    fragile: true,
    dims: { w: 17, h: 21, d: 17 },  // padded → 25×29×25 → LARGE box
    weight: 1.6,
    materials: 'Ceramic',
    ...
    images: [
      ...
      'images/rito-03.png',
      'images/rito-04.png',
      'images/carnival-05.png',
      'images/carnival-06.png',
    ],
  },

  // ─── WALL ART ──────────────────────────────────────────────────
  // Note: wall art dims are estimates pending measurement — mark clearly

  'candle-cat': {
    id: 'candle-cat',
    name: 'Cat Candle Holder',
    subtitle: 'wall art collection',
    category: ['wallart'],
    status: 'available',
    price: 50,
    fragile: true,
    dims: { w: 20, h: 25, d: 8 },  // ESTIMATE — pending measurement. padded → 28×33×16 → LARGE
    weight: 0.5,
    materials: 'Ceramic',
    dimsNote: 'Dimensions approximate — to be confirmed',
    ...
    images: [
      'images/portavela-catpower-01.png',
      'images/portavela-catpower-02.png',
    ],
  },

  'candle-freckles': {
    id: 'candle-freckles',
    name: 'Malva Freckles Candle Holder',
    subtitle: 'wall art collection',
    category: ['wallart'],
    status: 'available',
    price: 50,
    fragile: true,
    dims: { w: 20, h: 25, d: 8 },  // ESTIMATE — pending measurement
    weight: 0.5,
    materials: 'Ceramic',
    dimsNote: 'Dimensions approximate — to be confirmed',
  ...
  gaze: {
    ...
    price: 50,
    fragile: true,
    dims: { w: 22, h: 28, d: 6 },  // ESTIMATE — pending measurement
    weight: 0.6,
    materials: 'Ceramic',
    dimsNote: 'Dimensions approximate — to be confirmed',
  ...
  heartandfox: {
    ...
    images: [
      'images/heartandfox-01.png',
    ],
  },

  // ─── CUADROS ───────────────────────────────────────────────────
  // Small paintings (≤30cm): fit flat envelope Spain / small box international
  // Larger paintings: custom packaging required (standard Correos boxes too small)
  ...
  thewalk: {
    ...
    price: 60,
    fragile: false,
    dims: { w: 20, h: 20, d: 1.5 },  // flat envelope Spain / small box intl
    weight: 0.3,
  ...
  wait: {
    ...
    price: 215,
    fragile: false,
    dims: { w: 30, h: 30, d: 1.2 },  // fits flat envelope Spain / small box intl
    weight: null,
  ...
  marea: {
    ...
    materials: 'Acrylic on wood',
    framed: true,
    shippingNote: 'Shipping cost on request — requires custom packaging. Contact me for a quote.',
    images: [
      'images/marea-01.png',
      'images/marea-02.png',
      'images/marea-03.png',
  ...
  horizons: {
    ...
    shippingNote: 'Shipping cost on request — requires custom packaging. Contact me for a quote.',
    images: [
      'images/horizons-01.png',
      'images/horizons-02.png',
      'images/horizons-05.png',
    ],
  },
  ...
  encuentro: {
    ...
    shippingNote: 'Shipping cost on request — requires custom packaging. Contact me for a quote.',
    images: [
      'images/encuentros-01.png',
      'images/encuentros-02.png',
      'images/encuentros-03.png',
    ],
  },
  ...
  confluence: {
    ...
    materials: 'Acrylic on canvas',
    framed: false,
    shippingNote: 'Shipping cost on request — this large canvas requires custom packaging. Contact me for a quote.',
    images: [
      'images/confluence-01.png',
      'images/confluence-02.png',
      'images/confluence-03.png',
    ],
  },
  ...
  dreams: {
    ...
    shippingNote: 'Shipping cost on request — requires custom packaging. Contact me for a quote.',
    images: [
      'images/dreams-01.png',
      'images/dreams-02.png',
      'images/dreams-03.png',
      'images/dreams-04.png',
      'images/dreams-05.png',
    ],
  },
  ...
  'floral-dream-1': {
    ...
    priceSale: 120,
    fragile: false,
    dims: { w: 30, h: 40, d: 2 },  // framed drawing — small box intl
    weight: 0.6,
...
const PRODUCT_ORDER = [
  ...
  'floral-dream-1','floral-dream-2','master',
];
